...
const FLOOR_SIZE: Vec2 = Vec2::new(1200.0, 40.0);
const FLOOR_Y: f32 = -260.0;

const BLOCKER_SIZE: Vec2 = Vec2::new(36.0, 220.0);
const BLOCKER_POS: Vec2 = Vec2::new(-50.0, -130.0);

const HINGE_POS: Vec2 = Vec2::new(-120.0, 160.0);
const BAR_SIZE: Vec2 = Vec2::new(28.0, 260.0);
const BAR_START_ANGLE: f32 = -0.9;

const MOTOR_TARGET_VELOCITY: f32 = 2.4;
const MOTOR_MAX_TORQUE: f32 = 4000.0;
...
fn main() {
    ...
    app.add_plugins(DefaultPlugins.set(WindowPlugin {
        primary_window: Some(Window {
            title: "Avian Hinged Rectangle Motor Collision".into(),
...
fn setup(mut commands: Commands) {
    ...
    let swinging_bar = commands
        .spawn((
            Name::new("Motorized Hinged Rectangle"),
